...
from .scale_trans import FeatureTransformerC
...
class FeatureNet(nn.Module):
    ...
    def forward(self, feature0, feature1, 
        ...
        if flow is not None:
            flow = flow.detach()
            feature1 = flow_wrap(feature1, flow)
...
class GmaAtten(nn.Module):
    def __init__(self,
        ...
        # Transformer
        self.transformer = FeatureTransformerS(num_layers=num_transformer_layers,
                                              d_model=feature_channels,
                                              nhead=num_head,
                                              ffn_dim_expansion=ffn_dim_expansion,
                                              )
...
class ScaleFormer(nn.Module):
    def __init__(self,
        ...
        # Transformer
        self.transformer = FeatureTransformerC(num_layers=num_transformer_layers,
                                              d_model=feature_channels,
                                              nhead=num_head,
                                              ffn_dim_expansion=ffn_dim_expansion,
                                              )
